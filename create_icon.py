...
size = 180
img = Image.new('RGB', (size, size), (17, 17, 17))
...
try:
    draw.text((size/2, size/2 - 5), 'P', fill=(250, 250, 245), font=font, anchor='mm')
except TypeError:
    bbox = draw.textbbox((0,0), 'P', font=font)
    w = bbox[2] - bbox[0]
    h = bbox[3] - bbox[1]
    draw.text((size/2 - w/2, size/2 - h/2 - 15), 'P', fill=(250, 250, 245), font=font)
